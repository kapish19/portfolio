...
export const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: 'Work', href: '#work' },
    { name: 'Resume', href: 'https://drive.google.com/file/d/1uBnMhYxxqehqZYd_7vrhGRyh1LSe0owM/view?usp=sharing' },
      ...
      <div className="text-center z-10">
        ...
        <div className="mt-16 flex items-center justify-center gap-4">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <a 
              href="https://drive.google.com/file/d/1uBnMhYxxqehqZYd_7vrhGRyh1LSe0owM/view?usp=sharing"
              target="_blank"
